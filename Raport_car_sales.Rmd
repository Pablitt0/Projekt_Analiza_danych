...
Dla pozostałych zmiennych, wktórych występowały braki danych również zastosowaliśmy metodę `mice`, zmienna `Mileage` została wyestymowana za pomocą zależności od zmiennych: `Production_yea` oraz `Power_HP`, natomiast zmienna `Doors_number` na podstawie zmiennej `Type`.