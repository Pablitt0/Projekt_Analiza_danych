...
# Werifikacja hipotez, wizualizacja, analiza opisowa oraz testy statystyczne
...
### Hipoteza H2 (`Cena a rok produkcji`) 
...
### Hipoteza H3 (`Typ nadwozia a cena`) 
...
### Hipoteza H4 (`Skrzynia biegów a cena`)  
...
### Hipoteza H5 (`Pierwszy właściciel a cena`)  
...
### Hipoteza H7 (`Moc silnika a cena`)  
...
### Hipoteza H8 (`Paliwo a cena – BMW vs Mercedes`) 
...
### Hipoteza H9 (`Kolor a cena – premium psychologia`) 
...
### Hipoteza H10 (`Trwałość marki – cena/km`) 
...
## ANOVA Price ~ Fuel_type + Transmission
...
## Test ANOVA / Kruskal–Wallis Price ~ Fuel_type
